...
def main(args=None):
    ...
    if len(args) < 8:
        print("usage: vibrosim_process_compare_multisweep <datadir_path>  <xducer_velspec_filename_template> <xducer_displspec_filename_template> <laser_velspec_filename_template> <laser_displspec_filename_template> <crackcenterstressspec_filename_template> <xducer_veltime_filename> <xducer_displtime_filename> <laser_veltime_filename> <laser_displtime_filename> <[output_filename.csv.bz2] [plotdir] [endcrop_seconds]")
        print(" ")
