...
def main(args=None):
    ...
    if len(args) < 8:
        print("usage: vibrosim_process_multisweep <datadir_path>  <xducer_velspec_filename_template> <xducer_displspec_filename_template> <laser_velspec_filename_template> <laser_displspec_filename_template> <crackcenterstressspec_filename_template> [output_filename.csv.bz2] [plotdir] [endcrop_seconds]")
        print(" ")
        print("Example: vibrosim_process_multisweep .  meas1_withsegboundaries_xducercontactprobe_velspec_seg%d.txt meas1_withsegboundaries_xducercontactprobe_displspec_seg%d.txt meas1_withsegboundaries_laser_velspec_seg%d.txt meas1_withsegboundaries_laser_displspec_seg%d.txt meas1_withsegboundaries_crackcenterstressspec_seg%d.txt specimen_modeling_out.csv.bz2 . 0.1")
        print(" ")
        print("Optional templates (such as laser displacement, laser velocity, and crack center stress) can be specified as \"None\".")
        sys.exit(0)
        pass
    ...
    crackcenterstressspec_filename_template=args[6]
    if crackcenterstressspec_filename_template=="None":
        crackcenterstressspec_filename_template = None
        pass
