...
def train_surrogate(surrogate_type, # either "normal" or "shear"
    ...
    for idx in range(PP_range.shape[0]):
        ...
        (heating_power_per_m2_hertz[idx,:],
         ...
         vibration_ampl,
         vibration_shear_ampl,
         residual_sub,
         residual_add) = angled_friction_model(x_bnd,xrange,xstep,
                                                       numdraws,
                                                       YoungsModulus,
                                                       PoissonsRatio,
...
def calc_heating_singlefrequency(friction_coefficient,
    ...
    if crack_type_side1.lower() != "none":
        ...
        power_per_m2_side1 = np.ones(xrange.shape[0],dtype='d')*np.nan# None
        pass
    ...
    if crack_type_side2.lower() != "none":
        ...
        power_per_m2_side2 = np.ones(xrange.shape[0],dtype='d')*np.nan# None
        pass
