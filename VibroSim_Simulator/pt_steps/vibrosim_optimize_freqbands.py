...
def run(dc_modalfreqs_href,
    ...
    ret = {
        ...
        "dc:freqband_seg4_start": numericunitsv(seg4_freqstart,"Hz"),
        "dc:freqband_seg4_step": numericunitsv(seg4_freqstep,"Hz"),
        "dc:freqband_seg4_end": numericunitsv(seg4_freqend,"Hz"),
        }
    return ret
