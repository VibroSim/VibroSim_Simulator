...
.. py:function:: vibrocomsol_createdummyoutput
    ...
    @ref vibrocomsol_calc_heating_welder will populate this file with
    crack heating data. The processtrak step
    @ref vibrocomsol_heatflow_analysis_comsol will use the data to analyze
    heat flows.
...
.. py:function:: vibrocomsol_multisweep_seg_analysis_comsol
    ...
    :param dc\:seg%d_xducercontactprobe_displ: |segX_xducercontactprobe_displ|
    :param dc\:seg%d_xducercontactprobe_vel: |segX_xducercontactprobe_vel|
    :param dc\:seg%d_laser_displ: |segX_laser_displ|
    :param dc\:seg%d_laser_vel: |segX_laser_vel|
    :param dc\:seg%d_crackcenterstress: |segX_crackcenterstress|
...
.. py:function:: vibrosim_optimize_freqbands
    ...
    step @ref vibrocomsol_multisweep_seg_analysis_comsol. 
...
.. |vibro_heating_image| replace:: not_implemented
